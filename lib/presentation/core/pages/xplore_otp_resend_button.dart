...
// class XploreAnimatedButton extends StatefulWidget {
//   const XploreAnimatedButton({
//     Key? key,
//     required this.color,
//     required this.text,
//     required this.controller,
//     required this.loadedIcon,
...
//   @override
//   _XploreAnimatedButtonState createState() => _XploreAnimatedButtonState();
// }

// class _XploreAnimatedButtonState extends State<XploreAnimatedButton> with TickerProviderStateMixin {
...
//         .animate(CurvedAnimation(parent: _animationController, curve: Interval(0.0, 0.7, curve: Curves.ease)));
//     _buttonWidthAnimation = Tween<double>(begin: 400, end: 50)
//         .animate(CurvedAnimation(parent: _animationController, curve: Interval(0.7, 0.9, curve: Curves.decelerate)));
//     _checkIconOffsetAnimation = Tween<Offset>(begin: Offset(0, -2), end: Offset.zero)
//         .animate(CurvedAnimation(parent: _animationController, curve: Interval(0.9, 1.0, curve: Curves.easeOutBack)));
//   }
...
//                 color: widget.color,
//                 boxShadow: [
//                   BoxShadow(offset: Offset(0, 3), color: Colors.black12, blurRadius: 10.0, spreadRadius: 1.0)
//                 ]),
//             child: Stack(
//               children: <Widget>[
//                 Row(
